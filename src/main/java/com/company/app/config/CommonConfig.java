 ...
 */
@Configuration
@EnableJpaRepositories("com.company.domain.library.repository")
@EntityScan("com.company.domain.library.entity")
@EnableSwagger2
public class CommonConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Library API", "Library API", "v1", "Terms of service",
